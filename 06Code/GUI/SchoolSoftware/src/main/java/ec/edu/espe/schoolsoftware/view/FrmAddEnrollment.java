 ...
 */
public class FrmAddEnrollment extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FrmAddEnrollment.class.getName());

    /**
     * Creates new form FrmAddActivity
     */
    public FrmAddEnrollment() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Añadir Inscripción");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        FrmManageEnrollment frmManageEnrollment = new FrmManageEnrollment();
        frmManageEnrollment.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new FrmAddEnrollment().setVisible(true));
    }
