...
public class FrmStatistics extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FrmStatistics.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Generar Estadisticas");
        ...
        lblAverage.setText("Promedio del curso:");
        ...
        btnCalculateAverage.setText("Calcular promedio");
        btnCalculateAverage.addActionListener(this::btnCalculateAverageActionPerformed);
    ...
    private void btnCalculateAverageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalculateAverageActionPerformed
        ...
        double average
                = controller.calculateAverageGrade();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new FrmStatistics().setVisible(true));
    }
