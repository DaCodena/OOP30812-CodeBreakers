...
public class FrmAddActivity extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FrmAddActivity.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Añadir Actividad");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        FrmManageActivity frmManageActivity = new FrmManageActivity();
        frmManageActivity.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new FrmAddActivity().setVisible(true));
    }
